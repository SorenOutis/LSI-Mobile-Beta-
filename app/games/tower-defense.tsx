      ...
      <View style={styles.webWrap}>
        ...
        <View style={styles.gameArea}>
          <View style={styles.canvas}>
            ...
            <Text style={styles.canvasHint}>Level {level} · Tap to place towers</Text>
          </View>
        ...
        <View style={styles.actionRow}>
          ...
          <TouchableOpacity style={styles.primaryBtn} onPress={() => router.push('/games' as any)}><Text style={styles.primaryText}>Start Run</Text></TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
  );
